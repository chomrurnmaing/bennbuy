...
class _ShopScreenState extends State<ShopScreen> with TickerProviderStateMixin<ShopScreen>{
  ...
  List<String> gifting = [
    "https://bennbuy.com/wp-content/uploads/2018/07/Screen-Shot-2018-10-14-at-11.30.55-AM-990x400.png",
    "https://bennbuy.com/wp-content/uploads/2018/07/1-Oraimo-PowerBank-1-990x400.jpg",
    "https://bennbuy.com/wp-content/uploads/2018/07/Screen-Shot-2018-10-14-at-11.30.55-AM-990x400.png",
    "https://bennbuy.com/wp-content/uploads/2018/07/1-Oraimo-PowerBank-1-990x400.jpg",
  ];
  ...
  Widget _columnItems() {
    return Column(
      children: <Widget>[
        ListTile(
          title: Text('Eearn up to point per dollar'),
        ),
        Container(
          height: 300.0,
          child: ListView.builder(
              scrollDirection: Axis.horizontal,
              itemCount: gifting.length,
                    ...
                    children: <Widget>[
                      Positioned.fill(
                        child: FadeInImage(
                          ...
                          image: NetworkImage(gifting[index]),
                          fit: BoxFit.cover,
                        ),
                      ),
                      Positioned.fill(
