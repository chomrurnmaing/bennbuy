...
import 'package:bennbuy/widgets/product_detail/footer.dart';
                    ...
                    slivers: <Widget>[
                      ...
                      SliverList(
                        delegate: SliverChildListDelegate([
                          ...
                          EntrySummary( product, setAttributeValue, variationProduct ),
              ...
              itemBuilder: (context, i){
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white,
                    border: Border.all(color: selectedColor == attr['options'][i] ? getColorNamed(attr['options'][i]) : Colors.grey[300]),
