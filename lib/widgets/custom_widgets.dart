...
Widget buildRowStarRating({double icSize, double fontSize}){
  return Padding(
    padding: EdgeInsets.symmetric(vertical: 10.0),
    child: Row(
      children: <Widget>[
        Icon(Icons.star, size: icSize ?? 14.0,),
        Icon(Icons.star, size: icSize ?? 14.0,),
        Icon(Icons.star, size: icSize ?? 14.0,),
        Icon(Icons.star_half, size: icSize ?? 14.0,),
        Icon(Icons.star_border, size: icSize ?? 14.0,),
        ...
        Center(
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(Icons.star, size: 14.0,),
              Icon(Icons.star, size: 14.0,),
              Icon(Icons.star_half, size: 14.0,),
              Icon(Icons.star_border, size: 14.0,),
            ],
          ),
        ),
        Padding(
  ...
  return Container(
    ...
    child: Column(
      children: <Widget>[
        ...
        Text(heading ?? 'Sorry, something was wrong!', textAlign: TextAlign.center, style: TextStyle(
          fontSize: 16,
